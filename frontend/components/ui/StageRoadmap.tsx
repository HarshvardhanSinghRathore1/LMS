...
const STAGES: StageItem[] = [
  ...
  { id: 'STAGE 6', name: 'AI Features', description: 'AI-generated notes, AI MCQ generation with trainer review workflow, course-aware AI tutor with RAG retrieval.', status: 'completed' },
  { id: 'STAGE 7', name: 'Personalized Recommendations', description: 'Explainable recommendation engine using skill gaps, difficulty fit, and learning history.', status: 'completed' },
  { id: 'STAGE 8', name: 'Intelligent Trainer Matching', description: 'Deterministic 4-factor PostgreSQL matching engine (40% Skill Gap, 25% Rating, 20% Experience, 15% Capacity) & session requests.', status: 'completed' },
  { id: 'STAGE 9', name: 'Certificates', description: 'Deterministic completion verification, SHA-256 canonical hashing, public verification & vault.', status: 'completed' },
  { id: 'STAGE 10', name: 'Analytics', description: 'Deterministic SQL executive KPIs, enrollment funnels, and trainee analytics.', status: 'completed' },
  { id: 'STAGE 11', name: 'Notifications & Audit', description: 'Event-driven notification center and immutable enterprise audit explorer.', status: 'completed' },
  { id: 'STAGE 12', name: 'Advanced RAG & Persistent Context', description: 'pgvector document retrieval + Graphiti persistent temporal learner context contextual assistant.', status: 'completed' },
