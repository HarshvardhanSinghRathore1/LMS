    ...
    <main className="min-h-screen bg-[#0b090a] text-[#f5f3f4] flex items-center justify-center p-4">
      <div className="w-full max-w-md bg-[#161a1d] border border-neutral-800 rounded-xl p-8 shadow-2xl space-y-6">
        ...
        <div className="space-y-2 text-center">
          ...
          <p className="text-xs text-[#b1a7a6]">Register under your organization to begin capacity building</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-1">
            ...
            <input
              ...
              placeholder="ORG001"
              className="w-full bg-[#0b090a] border border-neutral-700 focus:border-[#e5383b] rounded-lg px-4 py-2 text-sm text-white placeholder-neutral-500 outline-none font-mono transition-colors"
            />
          </div>
        ...
        <div className="text-center pt-2 border-t border-neutral-800 text-xs text-[#b1a7a6]">
          Already registered?{' '}
          <Link href="/login" className="text-[#e5383b] hover:underline font-semibold">
            Sign In Here
          </Link>
        </div>
      </div>
